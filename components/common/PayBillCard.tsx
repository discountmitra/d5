...
const styles = StyleSheet.create({
  ...
  payBillTitle: { fontSize: 20, fontWeight: "700", color: "#fff", marginBottom: 4 },
  ...
  discountBadgeText: { fontSize: 12, fontWeight: "700", color: "#7c3aed", marginLeft: 4 },
  billInputSection: { marginBottom: 20 },
  billInputLabel: { fontSize: 14, color: "rgba(255,255,255,0.9)", marginBottom: 12, fontWeight: "500" },
  ...
  currencyText: { fontSize: 18, fontWeight: "700", color: "#fff" },
  billInput: { flex: 1, paddingVertical: 16, fontSize: 18, color: "#fff", fontWeight: "600" },
  payButton: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", paddingHorizontal: 20, paddingVertical: 12, borderRadius: 12, shadowColor: "#000", shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 2 },
  payButtonText: { fontSize: 14, fontWeight: "700", color: "#7c3aed", marginLeft: 4 },
  ...
  billSummaryTitle: { fontSize: 14, color: "rgba(255,255,255,0.9)", fontWeight: "600" },
  ...
  billSummaryLabel: { fontSize: 14, color: "rgba(255,255,255,0.8)", fontWeight: "500" },
  billSummaryValue: { fontSize: 14, color: "#fff", fontWeight: "600" },
  billSummaryDiscount: { fontSize: 14, color: "#10b981", fontWeight: "600" },
  billSummaryDivider: { height: 1, backgroundColor: "rgba(255,255,255,0.2)", marginVertical: 12 },
  finalAmountLabel: { fontSize: 16, color: "#fff", fontWeight: "700" },
  finalAmountValue: { fontSize: 20, fontWeight: "800", color: "#fff" },
});

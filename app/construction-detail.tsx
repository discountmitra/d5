...
export default function ConstructionDetailScreen() {
  ...
  const items: ConstructionData[] = [
    ...
    { category: 'Tiles & Stone', name: 'Tiles', description: 'All Types', rating: 4.6, reviews: 730, availability: 'Available Now' },
    { category: 'Interior Services', name: 'Plumbing Materials', description: 'Top Brands (Ashirvad, Prince, Kisan, Supreme & More)', rating: 4.7, reviews: 780, availability: 'Available Now' },
...
const styles = StyleSheet.create({
  ...
  section: { backgroundColor: '#fff', marginHorizontal: 16, marginBottom: 16, borderRadius: 16, padding: 20, shadowColor: '#000', shadowOpacity: 0.04, shadowOffset: { width: 0, height: 2 }, shadowRadius: 8, elevation: 2 },

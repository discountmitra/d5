  ...
  const data = useMemo<ConstructionItem[]>(
    () => [
      ...
      },
      {
        ...
        icon: "water",
        image: "https://plus.unsplash.com/premium_photo-1664301972519-506636f0245d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cGx1bWJpbmd8ZW58MHx8MHx8fDA%3D",
        rating: 4.7,
        reviews: 780,
        availability: "Available Now",
      },
